...
<form name="frm" class="form-horizontal" role="form"  method="POST" id='frm'>
	...
	<c:when test="${data.totalSize < 3 }">
	<a href="#" class="page" data-index="1">
    1
    </a>
    [다음]
    </c:when>
	...
	<c:forEach begin="1" end="3">
		...
		<a href="#" class="pageSize" data-pageName="next" data-page="1" data-pageSize="${data.pageSize}" data-totalSize="${data.totalSize}">
		[다음]
		</a>
	</c:otherwise>
	</c:choose>
