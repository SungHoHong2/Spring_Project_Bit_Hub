...
$(document).ready(function(){
	...
	$("#btnMessageReply").click(function(event){
		...
		var messageContent = $('.message-reply').val().replace(/\n/g, '<br>');
	...
	if($(".container-header").attr("data-totalCount") != 0) {
		$("#total-count").addClass("badge").html($(".container-header").attr("data-totalCount"));
	}else{
		$("#total-count").removeClass("badge").html("");
	}  
